...
/*Ppossivelmente, faremos uma chamada para o beckend na pagina de LOGIN, ou na CONTEXT DE AUTENTICAÇÃO, e nessa função, após pegar a resposta, faremos um push para:
...
export default function adminPage({params}:ParamsString){
    ...
    useEffect(()=>{
        push(`${params.clientName}/produtos`)
    },[])
